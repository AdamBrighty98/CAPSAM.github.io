   ...
   fluidRow(
      ...
      tabBox(title = "Parameters", width = 5,
         ...
         # Selecting GWP potentials for lifecycle assessments
          selectInput("gwpPotentials", "Please select either 20-year or 100-year global warming potentials (GWP): ", choices = gwpPotentials),
         
         # Selecting whether emissons/impacts should be illustrated per unit energy or absolute
         selectInput("absolute_or_perUnit", "Specify whether emissions/impacts should be stated as absolute or per unit energy", choices = per_unit_or_absolute_choice)
